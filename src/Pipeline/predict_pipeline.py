...
class PredictionPipelineConfig:
    ...
    class PredictionPipeline:
        ...
        def predict(self,features):
            ...
            def get_predicted_datafrane(self, input_dataframe_path: pd.DataFrame):
                ...
                try:
                    ...
                    input_dataframe.to_csv(self.pediction_pipeline_config.prediction_file_path, index= False)
